...
public class AddressPage extends BrowserUtility {
	...
	public String saveaddress(AddressPojo AddressPojo) {
		entertext(company_textbox_locator,AddressPojo.getCompany_());
		entertext(address1_textbox_locator,AddressPojo.getAddress1());
		entertext(address2_textbox_locator,AddressPojo.getAddress2());
		entertext(city_textbox_locator,AddressPojo.getCity_());
		entertext(post_code_textbox_locator,AddressPojo.getPost_());
		entertext(home_phone_textbox_locator,AddressPojo.getHome_());
		entertext(mobile_number_textbox_locator,AddressPojo.getMobile_());
		entertext(other_info_textbox_locator,AddressPojo.getOther_());
